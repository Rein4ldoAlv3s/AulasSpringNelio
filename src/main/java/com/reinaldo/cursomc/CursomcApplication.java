...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "564665", TipoCliente.PESSOAFISICA);   
		
		cli1.getTelefones().addAll(Arrays.asList("64636736", "32952444"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "390029145", cli1, c1);
		
		Endereco e2	 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "39744888", cli1, c2);
